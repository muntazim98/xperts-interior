    ...
    <div className="container py-12 xl-py-24 h-[auto]">
      <div className="grid lg:grid-cols-2 items-center">
        <motion.div
          ...
          <Image src="/image/homepage/aboutfront.webp"
            alt="About"
            width={1217}
            height={900}
        ...
        <div className="items-center">
          <motion.h2
            ...
            whileInView="onscreen"
            variants={titleVariants}
            className="px-4 lg:px-12 xl:px-12 2xl:px-12 py-4 text-3xl font-extrabold leading-tight lg-text-5xl">
          ...
          <motion.p
            ...
            className="px-4 lg:px-12 xl:px-12 2xl:px-12  tracking-wider uppercase text-gray-400 mt-3">Design Excellence Award</motion.p>
          <motion.p
            initial="offscreen"
            whileInView="onscreen"
            variants={desVariants}
            className="px-4 lg:px-12 xl:px-12 2xl:px-12 pb-4 mt-4 text-justify">
